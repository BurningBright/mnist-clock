 ...
 */
 ...
 function displayDigitHHmm(digit_0, digit_1, digit_2, digit_3) {
     if (digit_0 != -1)
 ...
 function displayDigitHHmmss(digit_0, digit_1, digit_2, digit_3, digit_4, digit_5) {
     if (digit_0 != -1)
         g_digit_data_0 = convertDigitData(digit_0)
     if (digit_1 != -1)
         g_digit_data_1 = convertDigitData(digit_1)
...
function drawTimeHHmm() {
    ...
    var pointCollection = displayDigitHHmm(
...
function drawTimeHHmmss() {
    ...
    var pointCollection = displayDigitHHmmss(
    digit_0 == old_digit_0? -1: digit_0
    , digit_1 == old_digit_1? -1: digit_1
    , digit_2 == old_digit_2? -1: digit_2
    , digit_3 == old_digit_3? -1: digit_3
...
if (getQueryVariable("style") != false)
style = getQueryVariable("style");

if (getQueryVariable("scale") != false)
    scale = getQueryVariable("scale");

if (getQueryVariable("width") != false)
    width = getQueryVariable("width");

if (getQueryVariable("height") != false)
